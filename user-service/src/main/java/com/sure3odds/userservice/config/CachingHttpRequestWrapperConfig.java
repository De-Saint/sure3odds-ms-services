...
public class CachingHttpRequestWrapperConfig  extends HttpServletRequestWrapper {


//    private byte[] requestBody = new byte[0];
//    private boolean bufferFilled = false;
//    private Map<String, String[]> parameterMap = new HashMap<>();
//    private Logger logger = LoggerFactory.getLogger(CachingHttpRequestWrapperConfig.class);
//
    /**
     ...
     */
    public CachingHttpRequestWrapperConfig(HttpServletRequest request) {
        super(request);
    }
//
//
